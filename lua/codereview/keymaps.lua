...
function M.setup(api)
  ...
  vim.keymap.set("n", maps.toggle_comment, api.toggle_comment, { desc = "CodeReview toggle comment" })
  vim.keymap.set("n", maps.anchor_comment, api.anchor_comment, { desc = "CodeReview anchor misplaced comment" })
  vim.keymap.set("n", maps.delete_comment, api.delete_comment, { desc = "CodeReview delete comment" })
